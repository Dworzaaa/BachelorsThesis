...
\begin{figure}
	\dirtree{%
		...
		.1 Database\DTcomment{the directory of the MySQL databse and database scripts}.
		.2 MySQL\DTcomment{the directory that contains MySQL database}.
		.2 data\DTcomment{the directory of a model of the database and migration scripts}.
