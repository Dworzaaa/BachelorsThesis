...
CITOVAT http://docs.spring.io/spring-framework/docs/2.0.x/reference/mvc.html
...
CITOVAT http://projects.spring.io/spring-security/
\begin{figure}[ht]\centering
...
\includegraphics[width=0.7\paperwidth]{exportDiagram}
...
\begin{figure}[ht]\centering
\includegraphics[width=0.8\paperwidth]{export}
...
\begin{figure}[ht]\centering
\includegraphics[width=0.8\paperwidth]{create}
