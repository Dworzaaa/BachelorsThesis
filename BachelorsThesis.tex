...
\begin{figure}
	\centering
 	\includegraphics[width=1\textheight, angle=90]{images/docxExport_1.png}
...
\begin{figure}
	\centering
 	\includegraphics[width=1\textheight, angle=90]{images/docxExport_2.png}
 	\caption{Screenshot of an export of all patients to docx}
...
\begin{figure}
	\centering
 	\includegraphics[width=1\textheight, angle=90]{images/txtExport.png}
...
\begin{figure}
	\centering
 	\includegraphics[width=1\textheight, angle=90]{images/xlsExport_1.png}
...
\begin{figure}
	\centering
 	\includegraphics[width=1\textheight, angle=90]{images/xlsExport_2.png}
 	\caption{Screenshot of an export of all patients older then 5 years to xls}
...
\begin{figure}
	\dirtree{%
		...
		.2 images \DTcomment{the directory of images used in the thesis}.
